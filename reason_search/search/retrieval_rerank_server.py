...
if __name__ == "__main__":
    ...
    # retriever
    parser.add_argument("--index_path", type=str, default="wiki-18/e5_Flat.index", help="Corpus indexing file.")
    parser.add_argument("--corpus_path", type=str, default="data/retrieval-corpus/wiki-18.jsonl", help="Local corpus file.")
